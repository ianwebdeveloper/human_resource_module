...
<?php foreach($records as $rec):?>
	...
	<p class="hr_objective_header"><h3>Career Objective</h3><a href="<?php echo base_url();?>a/profile/add_objective/<?php echo $rec->account_id ?>">Add</a>| <a href="<?php echo base_url();?>a/profile/edit_objective/<?php echo $rec->account_id ?>">Edit</a></p>
...
<p class="hr_resume_education_header"><h3>Education</h3><a href="<?php echo base_url();?>a/profile/add_education/<?php echo $rec->account_id ?>">Add</a></p>
